...
@section('content')
	<div class="container">
		...
		<h3 style="text-align: center;">Tambah Barang</h3><br>
	
  	<form class="form-horizontal" action="/simpanBarang" method="post" enctype="multipart/form-data">
      {{csrf_field()}}
  		<div class="form-group{{ $errors->has('jenis_kayu') ? ' has-error' : '' }}">
    		<label for="jenis_kayu" class="col-sm-4 control-label">Jenis Kayu</label>
    	<div class="col-sm-5">
      		<input type="text" class="form-control" name="jenis_kayu" placeholder="Jenis Kayu " required>
    ...
    <div class="col-sm-5">
      <input type="number" min="0" class="form-control" name="stok" placeholder="Stok Tersedia" required>
    @if ($errors->has('stok'))
        <span class="help-block">
    ...
    <div class="col-sm-5">
      <input type="number" min="1" class="form-control" name="harga" placeholder="Harga Kayu" required>
    @if ($errors->has('harga'))
        <span class="help-block">
    ...
    <div class="col-sm-5">
      <textarea name="deskripsi" class="form-control" placeholder="Deskripsikan Kayu Disini" required></textarea>
